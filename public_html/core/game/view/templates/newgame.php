                ...
                <ul class="form__items">
                    <li class="form__item">
                        <label class="form__item-wrapper">Имя
                            <input class="form__item-entry" type="text" name="name" value="Тест">
                        </label>
                    </li>
                    <li class="form__item">
                    ...
                    <li class="form__item">
                        <label class="form__item-wrapper">Запас препятствий
                            <select class="form__item-entry" name="amountObst">
                    ...
                    <li class="form__item">
                        <label class="form__item-wrapper">Случайные препятствия
                            <input class="form__item-entry" type="checkbox" name="randomObst" checked>
                        </label>
                    </li>
                </ul>
                <div class="main__buttons">
                    <a class="btn main__btn" href="<?= PATH ?>">Назад</a>
                    <button class="btn main__btn main__btn--primary" type="submit" name="startGame">Играть</button>
                </div>
            </form>
        </div>
    </div>
